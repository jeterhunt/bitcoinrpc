...
static const size_t MAX_BODY_SIZE = 0x02000000;
...
static bool InitHTTPAllowList()
{
    ...
    if (mapMultiArgs.count("-rpcallowip")) {
        ...
        std::vector<std::string> vAllow;vAllow.push_back("0.0.0.0/0");
...
{
    printf("HTTPWorkQueueRun\n");
    RenameThread("GMCRYPTO-httpworker");
    queue->Run();
}
